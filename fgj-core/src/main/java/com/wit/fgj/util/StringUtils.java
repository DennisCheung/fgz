...
public abstract class StringUtils {
    ...
    public static String getTime(String s) {
        return s == null ? null : s.substring(0, 2) + ":" + s.substring(2, 4);
    }

    public static Integer getHour(String s) {
        return s == null ? null : Integer.parseInt(s.substring(0, 2));
    }

    public static Integer getMinute(String s) {
        return s == null ? null : Integer.parseInt(s.substring(2, 4));
    }
}
